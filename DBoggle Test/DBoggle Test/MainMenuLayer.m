...
-(id) init
{
	...
	if( (self=[super init]) ) {
        ...
        CCMenuItemImage *credits = [CCMenuItemImage itemWithNormalImage:@"credits_inactive.png" selectedImage:@"credits_active.png" target:self selector:@selector(otherOption)];
